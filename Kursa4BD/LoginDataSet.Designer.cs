...
namespace Kursa4BD {
    ...
    public partial class LoginDataSet : global::System.Data.DataSet {
        ...
        public partial class ЛогинDataTable : global::System.Data.TypedTableBase<ЛогинRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ЛогинRow AddЛогинRow(string логин, string пароль, string тип) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ЛогинRow FindByid(int id) {
        ...
        public partial class ЛогинRow : global::System.Data.DataRow {
            ...
            public int id {
                get {
                    return ((int)(this[this.tableЛогин.idColumn]));
                }
                set {
                    this[this.tableЛогин.idColumn] = value;
                }
            }
            ...
            public string пароль {
                get {
                    return ((string)(this[this.tableЛогин.парольColumn]));
                }
                set {
                    this[this.tableЛогин.парольColumn] = value;
                }
            }
            ...
            public string тип {
                get {
                    return ((string)(this[this.tableЛогин.типColumn]));
                }
                set {
                    this[this.tableЛогин.типColumn] = value;
                }
            }
        }
...
namespace Kursa4BD.LoginDataSetTableAdapters {
    ...
    public partial class ЛогинTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Логин] WHERE (([id] = @Original_id) AND ([логин] = @Original_л" +
                "огин) AND ([пароль] = @Original_пароль) AND ([тип] = @Original_тип))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Логин] ([логин], [пароль], [тип]) VALUES (@логин, @пароль, @ти" +
                "п);\r\nSELECT id, логин, пароль, тип FROM Логин WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Логин] SET [логин] = @логин, [пароль] = @пароль, [тип] = @тип WHERE (([id] = @Original_id) AND ([логин] = @Original_логин) AND ([пароль] = @Original_пароль) AND ([тип] = @Original_тип));
SELECT id, логин, пароль, тип FROM Логин WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, логин, пароль, тип FROM dbo.Логин";
        ...
        public virtual int Fill(LoginDataSet.ЛогинDataTable dataTable) {
        ...
        public virtual LoginDataSet.ЛогинDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LoginDataSet.ЛогинDataTable dataTable = new LoginDataSet.ЛогинDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LoginDataSet.ЛогинDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_логин, string Original_пароль, string Original_тип) {
        ...
        public virtual int Update(string логин, string пароль, string тип, int Original_id, string Original_логин, string Original_пароль, string Original_тип, int id) {
            if ((логин == null)) {
                throw new global::System.ArgumentNullException("логин");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string логин, string пароль, string тип, int Original_id, string Original_логин, string Original_пароль, string Original_тип) {
            return this.Update(логин, пароль, тип, Original_id, Original_логин, Original_пароль, Original_тип, Original_id);
        }
    }
